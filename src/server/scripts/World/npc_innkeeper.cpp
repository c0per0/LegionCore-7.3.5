...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        if (IsEventActive(HALLOWEEN_EVENTID) && !player->HasAura(SPELL_TRICK_OR_TREATED))
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, localizedEntry, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+HALLOWEEN_EVENTID);
        }
        ...
        if (creature->isInnkeeper())
        {
            ...
            player->ADD_GOSSIP_ITEM(GOSSIP_NPC_INTERACT_1, localizedEntry, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INN);
        }
