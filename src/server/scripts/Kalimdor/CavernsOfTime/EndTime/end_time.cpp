...
class go_end_time_teleport : public GameObjectScript
{
    public:
        ...
        bool OnGossipHello(Player* pPlayer, GameObject* pGo)
        {
            ...
            {
                pPlayer->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, ru ? "Entryway of Time.":"Entryway of Time.", GOSSIP_SENDER_MAIN, START_TELEPORT);

                if (pPlayer->isGameMaster())
                {
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, ru ? "Emerald Dragonshrine.":"Emerald Dragonshrine.", GOSSIP_SENDER_MAIN, TYRANDE_TELEPORT);
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, ru ? "Azure Dragonshrine.":"Azure Dragonshrine.", GOSSIP_SENDER_MAIN, JAINA_TELEPORT);
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, ru ? "Obsidian Dragonshrine.":"Obsidian Dragonshrine.", GOSSIP_SENDER_MAIN, BAINE_TELEPORT);
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, ru ? "Ruby Dragonshine.":"Ruby Dragonshrine.", GOSSIP_SENDER_MAIN, SYLVANAS_TELEPORT);
                    pPlayer->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, ru ? "Bronze Dragonshrine.":"Bronze Dragonshrine.", GOSSIP_SENDER_MAIN, MUROZOND_TELEPORT);
                }
                else
                {
