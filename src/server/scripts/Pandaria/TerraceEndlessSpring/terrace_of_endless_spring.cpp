...
public:
    ...
    bool OnGossipHello(Player * player, Creature * Creature)
    {
        if (player->GetQuestRewardStatus(QuestFearItself))
            player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Sha Touched Weapon Gems", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);

        if (player->GetQuestRewardStatus(QuestTheCrownOfHeaven))
            player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Sha Touched Head Gems", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);

        if (player->GetQuestRewardStatus(QuestTheSoulOfTheHorde) || player->GetQuestRewardStatus(QuestCallThePackMaster))
            player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Eye of the Black Prince [2500 gold coins]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);

        if (player->GetQuestRewardStatus(QuestCloakOfVirtue))
            player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Cloaks", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);

        if (player->GetQuestRewardStatus(QuestPandarenLegend))
            player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Legenday enchant [1000 gold coins]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);


        player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "No thank you..", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 60);
    ...
    bool OnGossipSelect(Player * player, Creature * Creature, uint32 sender, uint32 actions)
    {
        ...
        if (sender == GOSSIP_SENDER_MAIN)
        {
            ...
            case GOSSIP_ACTION_INFO_DEF + 1: // Sha Touched Weapon gems
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Crystalized Dread [10k gold coins]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 51);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Crystalized Horror [10k gold coins]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 52);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Crystalized Terror [10k gold coins]", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 53);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Exit..", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 60);
            ...
            case GOSSIP_ACTION_INFO_DEF + 2: // Sha Touched Weapon gems
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Indomitable Primal Diamond", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 20);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Courageous Primal Diamond", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 21);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Capacitive Primal Diamond", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 22);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Sinister Primal Diamond", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 23);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Exit..", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 60);
            ...
            case GOSSIP_ACTION_INFO_DEF + 3: // Cloaks
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Oxhorn Bladebreaker", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 31);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Tigerclaw Cape", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 32);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Tigerfang Wrap", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 33);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Cranewing Cloak", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 34);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Jadefire Drape", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 35);
                player->ADD_GOSSIP_ITEM(GOSSIP_NPC_CHAT, "Oxhoof Greatcloak", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 36);
